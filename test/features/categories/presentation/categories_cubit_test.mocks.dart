...
// in shopping/test/features/categories/presentation/categories_cubit_test.dart.
...
import 'package:shopping/core/usecases/no_params.dart' as _i7;
...
class MockCategoriesUseCase extends _i1.Mock implements _i3.CategoriesUseCase {
  ...
  @override
  _i4.Future<_i2.Either<_i5.Failure, List<_i6.Category>>> call(
          _i7.NoParams? params) =>
      (super.noSuchMethod(
        Invocation.method(
          #call,
