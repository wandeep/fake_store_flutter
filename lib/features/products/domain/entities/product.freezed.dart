...
class _$_Product implements _Product {
  ...
  @override
  String toString() {
    return 'Product(id: $id, title: $title, price: $price, description: $description, category: $category, imageUri: $imageUri, rating: $rating)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, title, price, description, category, imageUri, rating);
...
class _$_Rating implements _Rating {
  _$_Rating({required this.rate, required this.count});
